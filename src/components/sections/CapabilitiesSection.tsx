                        ...
                        <div key={cap.category} role="group" aria-label={cap.category} className="border-t-[0.5px] flex flex-col"
                            ...
                            <div className="flex flex-col">
                                {cap.items.map((item, index) => (
                                    <div 
                                        key={index}
                                        className="group flex items-center justify-between cursor-default transition-all duration-150 ease hover:bg-[var(--bg-raised)]"
                                        style={{ 
                                            padding: '7px 0',
                                        ...
                                        title={item.tooltip}
                                    >
                                        <span className="font-mono text-[11.5px] text-[var(--text-secondary)] group-hover:text-[var(--text-primary)] transition-colors duration-150 ease">
                                            {item.name}
                                        </span>
                                        {item.projectRef && (
                                            <a 
                                                href="#work"
                                                className="font-mono px-2 cursor-pointer text-[var(--text-muted)] group-hover:text-[var(--accent-green)] transition-colors duration-150 ease"
